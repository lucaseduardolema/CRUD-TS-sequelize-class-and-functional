...
router.get("/search", (req, res) => productController.getProductsPriceBetwen(req, res));
router.get("/in-validity", (req, res) => productController.nonExpirateProducts(req, res));
router
    .route("/")
